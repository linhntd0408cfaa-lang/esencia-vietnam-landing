...
window.ESENCIA_DATA.months = [
  ...
  {m:11, name:'Noviembre',
   weather:'Otoño agradable en el norte y comienzo de la temporada seca en el sur. En el centro no programamos viajes en noviembre por el riesgo de lluvias y tormentas.',
   zones:{norte:'bueno',centro:'evitar',sur:'bueno'},
   zoneNotes:{
     norte:'Otoño fresco (17-33°C aprox. entre agosto y noviembre), buena visibilidad; en las montañas empieza a enfriar.',
     centro:'Riesgo de lluvias fuertes y tormentas; en noviembre evitamos el centro (Da Nang, Hoi An y Hue).',
